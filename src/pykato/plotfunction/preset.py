...
def Histogram_Colorbar_Preset(data: np.ndarray, figure: Figure | None = None, nbins=256, vmin: float = 0, vmax: float = 1.0, cmap: str = "viridis", position: str = "right") -> Figure:
    """
