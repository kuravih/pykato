...
def Phaser_Preset(ax: Axis, light: Tuple[complex, complex], color: str = "red", stops: List[float] = [0.125, 0.375, 0.625, 0.875]):
    """
    Plot phaser

    Example:
        phaser_plot(plot_ax, pol_curve, color='red', stops=[0.125, 0.375, 0.625, 0.875]):

    Parameters:
        ax: Axis:
            plot axis
        light: Tuple[complex, complex]
            phaser curve point (generated by phaser_curve)
        color: str = "red"
            color
        stops: List[float] = [0.125, 0.375, 0.625, 0.875]
