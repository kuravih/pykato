...
from pykato.plotfunction.preset import Imshow_Colorbar_Preset, Complex_Imshow_TwoColorbars_Preset, ImageGrid_Preset, ImageGrid_Colorbar_Preset, Complex_ImageGrid_TwoColorbars_Preset
...
class TestPreset(BaseTestPreset):
    ...
    def test_Complex_Imshow_2Colorbars_Preset(self):
        complex_imshow_2colorbars_preset = Complex_Imshow_TwoColorbars_Preset(self.data["polka_vortex_complex_test_image"])
    ...
    def test_Complex_ImageGrid_2Colorbars_Preset(self):
        complex_image_grid_2colorbars_preset = Complex_ImageGrid_TwoColorbars_Preset(tuple(self.data[key] for key in ("polka_vortex_complex_test_image", "checkers_vortex_complex_test_image", "sinusoid_vortex_complex_test_image", "gauss_vortex_complex_test_image")))

        self.assertIsInstance(complex_image_grid_2colorbars_preset, Figure, "Figure not created by preset.Complex_ImageGrid_2Colorbars_Preset")

        imshow1_ax, imshow2_ax, imshow3_ax, imshow4_ax, _, _ = complex_image_grid_2colorbars_preset.get_axes()
        ...
        complex_image_grid_2colorbars_preset.savefig("tests/output/preset_Complex_ImageGrid_2Colorbars_Preset.png")
